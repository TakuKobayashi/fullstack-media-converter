export const messages = {
  en: {
    ...
    model3d: {
      ...
      dropRelatedForModel: 'Drop related files for this model here',
      ...
      convertModels: 'Convert {{count}} 3D models',
      clearAllModels: 'Clear all 3D models',
  ...
  ja: {
    ...
    model3d: {
      ...
      dropRelatedForModel: 'このモデルの関連ファイルをここにドロップ',
      ...
      convertModels: '3Dモデル{{count}}件を変換',
      clearAllModels: 'すべての3Dモデルをクリア',
      clearAllAnimations: 'すべてのアニメーションをクリア',
